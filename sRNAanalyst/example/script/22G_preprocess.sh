...
../../src/Bowtie2/bowtie2-build $ref $bwt --threads ${CPU_core} > ${log}/bowtie2-build_normalize.log 2>&1
../../src/Bowtie2/bowtie2 -x $bwt -f ${data}_collapsed.fa -S ${data}_mapped.sam --threads ${CPU_core} ${bowtie} > ${log}/bowtie2_normalize.log 2>&1
